...
within their generation.  See Appendix chapter~\nameref{ch:shp}}
...
serious study:
\begin{enumerate}
    \item it was based on late manuscripts that had accumulated a
considerable number of scribal errors, and 
    \item several hundred English words
...
another---must be used with caution.\sidenote{See chapter~\nameref{ch:rightly}, on the analogy 
...
characteristics of the prooftext method, see chapter~\nameref{ch:rightly}} They did not
