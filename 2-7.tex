...
individual and corporate response to this instruction.\sidenote{My article
\bibentry{35} classifies and summarizes
...
except for this caveat.} The Hebrew language
...
was written \textit{br'} (consonants only). The Masoretes supplied vowels to make it
read \textit{bara'}, ``created.'' With equal reason they might as well have supplied
vowels to make it read \textit{bore'}, which would have verse 1 read ``When God began
...
another---must be used with caution.\sidenote{See \nameref{ch:rightly}, on the analogy 
...
sanctuary located in the ``beautiful'' land (\textit{tsebi}), Judea. Chapter 11:16, 41
confirms this identification, and in 11:45 \textit{tsebi} the `beautiful' holy
...
characteristics of the prooftext method, see \nameref{ch:rightly}} They did not
...
Sanctuary doctrine see~\bibentry{24}, pages 115--121, or~\bibentry{24a}, pages 73--88}
