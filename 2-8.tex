...
\section{Four KJV Translation Errors That Led Pioneer Adventists Astray}
...
The word \textit{tamid}, ``continual(ly),'' ``regular(ly),'' occurs 104 times in the Old
...
would be 1,150 literal twenty-four-hour days, or three years, two months, and
...
Daniel's time, ``the distant future.''\sidenote{\nameref{ch:daniel9}:26}
